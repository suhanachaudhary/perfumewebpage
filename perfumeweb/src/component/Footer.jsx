...
<footer className="footer">
  ...
  <div className="bg-primary py-xl-3 py-xxl-9 border-top border-light">
    <div className="container overflow-hidden">
      <div className="row gy-5 gy-md-0 align-items-md-center">
        <div className="col-xs-12 col-md-7 order-1 order-md-0">
          ...
          <div className="credits text-center text-md-start mt-2 fs-8">
            Built by <a href="https://bootstrapbrain.com/" className="text-decoration-none">Suhana Chaudhary</a> with <span className="text-danger">&#9829;</span>
          </div>
        </div>
